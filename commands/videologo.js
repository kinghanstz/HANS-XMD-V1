...
const { king } = require("../felix/king");
const axios = require("axios");

king({ nomCom: "videologo", categorie: "modern-logo", reaction: "✋" }, async (dest, zk, commandeOptions) => {
...
*Enjoy 😊*`;
    ...
    const contextInfo = {
      ...
      externalAdReply: {
        title: "HANS 𝗠𝗗",
        body: "Regards, HansTz",
        thumbnailUrl: "https://files.catbox.moe/9mcdru.jpg",
