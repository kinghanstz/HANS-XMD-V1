...
hans({
  ...
  const murl = 'https://whatsapp.com/channel/0029VasiOoR3bbUw5aV4qB31';
  const img = 'https://files.catbox.moe/9mcdru.jpg';
  ...
  const audioMessage = {
    ...
    contextInfo: {
      externalAdReply: {
        title: 'HANS-MD IS ALIVE',
        body: 'Regards HANSTZ-TECH',
        thumbnailUrl: img,
        sourceUrl: murl,
        mediaType: 1,
