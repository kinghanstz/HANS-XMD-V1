...
async (Void, citel, text) => {
    ...
    let apiUrl = `https://api.telegra.ph/createPage?access_token=${apiToken}&title=Hans-Md+Bot&author_name=SamPandey001&content=[%7B"tag":"p","children":["${a.replace(/ /g, '+')}"]%7D]&return_content=true`;
