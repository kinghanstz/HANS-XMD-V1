...
hans({nomCom:"ai3",reaction:"💡",categorie:"IA"},async(dest,zk,commandeOptions)=>{
...
.catch(error => {
  ...
  hans({ nomCom: "bing4", reaction: "🌀", categorie: "IA" }, async (dest, zk, commandeOptions) => {
  ...
  hans({ nomCom: "ai2", reaction: "🌀", categorie: "IA" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
...
hans({ nomCom: "gpt4", reaction: "🌀", categorie: "IA" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
