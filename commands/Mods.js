...
const sleep =  (ms) =>{
  ...
  hans({ nomCom: "tgs", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
hans({ nomCom: "crew", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
hans({ nomCom: "join", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
hans({ nomCom: "jid", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
hans({ nomCom: "block", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
hans({ nomCom: "unblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
hans({ nomCom: "kickall", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
hans({ nomCom: "save", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
