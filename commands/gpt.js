const { Hanstz } = require("../hans/Hanstz");
const axios = require("axios");

// C'est la commande pour interagir avec ChatGPT thomas
Hanstz({ nomCom: "gpt3", reaction: "🌐", categorie: "IA" }, async (dest, zk, commandeOptions) => {
    ...
    try {
        ...
        const responseApi = await axios.get(`https://api.davidcyriltech.my.id/ai/chatbot?query=${question}&name=Kaizoku&prompt=${encodeURIComponent("Tu seras une IA d'un bot WhatsApp tres puissant du nom HANS-MD")}&apikey=BrunoSobrino`);
