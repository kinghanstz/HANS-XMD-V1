...
hans({nomCom:"s",categorie: "Conversion", reaction: "✨"},async(origineMessage,zk,commandeOptions)=>{
...
hans({nomCom:"croppic",categorie: "Conversion", reaction: "😎"},async(origineMessage,zk,commandeOptions)=>{
...
hans({nomCom:"getsticker",categorie: "Conversion", reaction: "😿"},async(origineMessage,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
hans({ nomCom: "words", categorie: "Conversion", reaction: "😂" }, async (origineMessage, zk, commandeOptions) => {
  const { ms, msgRepondu, arg, repondre, nomAuteurMessage } = commandeOptions;
...
hans({nomCom:"picture",categorie: "Conversion", reaction: "💀"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
hans({ nomCom: "trt", categorie: "Conversion", reaction: "⌛" }, async (dest, zk, commandeOptions) => {
