...
const { format, styletext } = require(__dirname + "/../Hanstz/mesfonctions");
//const {police}=require(__dirname+"/../Hanstz/mesfonctions")
const os = require("os");
const moment = require("moment-timezone");
const s = require(__dirname + "/../set");
hans({ nomCom: "cpu", categorie: "deploy" }, async (dest, zk, commandeOptions) => {
...
𝚔𝚎𝚎𝚙 𝚞𝚜𝚒𝚗𝚐 HANS MD\n\n`;
    ...
    var link = "https://files.catbox.moe/9mcdru.jpg";
    try {
